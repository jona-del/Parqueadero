...
/*-----------------------------------------------
              @(target):= _parqueadero.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__parqueadero

#else
#  define SWIG_init    init_parqueadero
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_obtenerDatosParqueadero(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  char *result = 0 ;
  
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "obtenerDatosParqueadero", 0, 0, 0)) SWIG_fail;
  result = (char *)obtenerDatosParqueadero();
...
static PyMethodDef SwigMethods[] = {
	 { "obtenerDatosParqueadero", _wrap_obtenerDatosParqueadero, METH_NOARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
